            ...
            <form action="../reviews.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="form-check">
                        <input name="checkboxData[agreeTerms]" class="form-check-input" type="checkbox" value="check" id="defaultCheck1" required>
                        <label class="form-check-label" for="defaultCheck1">
                        Принимаю согласие на обработку данных
                        </label>
                    </div>
                    <div class="form-check">
                        <input name="checkboxData[emailCheck]" class="form-check-input" type="checkbox" value="check" id="defaultCheck2">
                        <label class="form-check-label" for="defaultCheck2">
                            email рассылка
                        </label>
                    </div>
                    <div class="form-check">
                        <input name="checkboxData[fastAnswer]" class="form-check-input" type="checkbox" value="check" id="defaultCheck3">
